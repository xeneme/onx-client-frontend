<template>
  <div class="page">
    ...
    <referral-popup :value="referralPopup" />
      ...
      <div class="essentials">
        ...
        >
          ...
          <div class="promo__title">
            <span class="title">
              <fa icon="ticket-alt" class="icon" />
              Activate promo code</span
            >
            <input
              ref="promo-value"
              type="text"
        ...
        <a class="invite" @click="popupReferral">
          <div class="invite__title">
            <span class="title">
              <fa icon="user-plus" ref="referalUserIcon" class="icon" />
              <fa
                icon="check"
                ref="referalCheckIcon"
                style="display:none"
                class="icon"
              />
              <span ref="referalTitle">
                Invite friends<span class="plus">+</span>
              </span>
            </span>
          </div>
        </a>
...
import TwoFA from '@/components/views/profile/components/ProfileInput'
import InlineSpinner from '@/components/partial/InlineSpinner'
import ReferralPopup from '@/components/views/profile/ReferralPopup'
